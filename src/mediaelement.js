...
import 'src/js/renderers/html5.js'
import 'src/js/renderers/flash.js'
import 'src/js/renderers/dash.js'
import 'src/js/renderers/flv.js'
import 'src/js/renderers/hls.js'
import 'src/js/renderers/youtube.js'


import window from 'global/window';
import document from 'global/document';
import mejs from './js/core/mejs';
import {createEvent} from 'js/utils/general';
import {getTypeFromFile, formatType, absolutizeUrl} from 'js/utils/media';
import {renderer} from './js/core/renderer';
import {IS_IOS} from 'js/utils/constants';
...
class MediaElement {
    ...
    /**
     *
     * @param {String|Node} mediaEl
     * @param {Object} options
     * @param {Object[]} sources
     * @returns {Element|*}
     */
    constructor(mediaEl, options, sources) {
        ...
        if (typeof mediaEl === 'string') {
            t.mediaElement.originalNode = document.getElementById(mediaEl);
        } else {
            t.mediaElement.originalNode = mediaEl;
            id = mediaEl.id;
        }
