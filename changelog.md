...
*6.0.3* (2023/03/06)
* `outline-style: auto` has been changed to `outline-style: solid` in the CSS `focus:` pseudo-class in the class `mejs__container`. This will enable Firefox to show the correct `outline-color` on focus if defined. (#2924)
