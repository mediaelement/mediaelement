...
typeof this.nav.mimeTypes||!this.nav.mimeTypes[b]||this.nav.mimeTypes[b].enabledPlugin))for(e=c.replace(a,"").replace(/^\s+/,"").replace(/\sr/gi,".").split("."),a=0;a<e.length;a++)e[a]=parseInt(e[a].match(/\d+/),10)}else if("undefined"!=typeof window.ActiveXObject)try{(g=new ActiveXObject(c))&&(e=d(g))}catch(f){}return e}};
...
b.mode&&"auto_plugin"!==b.mode&&"native"!==b.mode||mejs.MediaFeatures.isBustedNativeHTTPS&&!0===b.httpsBasicAuthSite)){d||(f=document.createElement(h.isVideo?"video":"audio"),a.parentNode.insertBefore(f,a),a.style.display="none",h.htmlMediaElement=a=f);for(f=0;f<g.length;f++)if("video/m3u8"==g[f].type||""!==a.canPlayType(g[f].type).replace(/no/,"")||""!==a.canPlayType(g[f].type.replace(/mp3/,"mpeg")).replace(/no/,"")||""!==a.canPlayType(g[f].type.replace(/m4a/,"mp4")).replace(/no/,"")){h.method="native";
h.url=g[f].url;break}if("native"===h.method&&(null!==h.url&&(a.src=h.url),"auto_plugin"!==b.mode))return h}if("auto"===b.mode||"auto_plugin"===b.mode||"shim"===b.mode)for(f=0;f<g.length;f++)for(m=g[f].type,a=0;a<b.plugins.length;a++)for(e=b.plugins[a],k=mejs.plugins[e],c=0;c<k.length;c++)if(l=k[c],null==l.version||mejs.PluginDetector.hasPluginVersion(e,l.version))for(d=0;d<l.types.length;d++)if(m==l.types[d])return h.method=e,h.url=g[f].url,h;if("auto_plugin"===b.mode&&"native"===h.method)return h;
...
createPlugin:function(a,b,c,d,e,g){c=a.htmlMediaElement;var f=1,k=1,m="me_"+a.method+"_"+mejs.meIndex++,h=new mejs.PluginMediaElement(m,a.method,a.url),l=document.createElement("div"),p;h.tagName=c.tagName;for(p=0;p<c.attributes.length;p++){var q=c.attributes[p];1==q.specified&&h.setAttribute(q.name,q.value)}for(p=c.parentNode;null!==p&&"body"!==p.tagName.toLowerCase()&&null!=p.parentNode;){if("p"===p.parentNode.tagName.toLowerCase()){p.parentNode.parentNode.insertBefore(p,p.parentNode);break}p=p.parentNode}a.isVideo?
(f=0<b.pluginWidth?b.pluginWidth:0<b.videoWidth?b.videoWidth:null!==c.getAttribute("width")?c.getAttribute("width"):b.defaultVideoWidth,k=0<b.pluginHeight?b.pluginHeight:0<b.videoHeight?b.videoHeight:null!==c.getAttribute("height")?c.getAttribute("height"):b.defaultVideoHeight,f=mejs.Utility.encodeUrl(f),k=mejs.Utility.encodeUrl(k)):b.enablePluginDebug&&(f=320,k=240);h.success=b.success;mejs.MediaPluginBridge.registerPluginElement(m,h,c);l.className="me-plugin";l.id=m+"_container";a.isVideo?c.parentNode.insertBefore(l,
c):document.body.insertBefore(l,document.body.childNodes[0]);d=["id="+m,"jsinitfunction=mejs.MediaPluginBridge.initPlugin","jscallbackfunction=mejs.MediaPluginBridge.fireEvent","isvideo="+(a.isVideo?"true":"false"),"autoplay="+(d?"true":"false"),"preload="+e,"width="+f,"startvolume="+b.startVolume,"timerrate="+b.timerRate,"flashstreamer="+b.flashStreamer,"height="+k,"pseudostreamstart="+b.pseudoStreamingStartQueryParam];null!==a.url&&("flash"==a.method?d.push("file="+mejs.Utility.encodeUrl(a.url)):
d.push("file="+a.url));b.enablePluginDebug&&d.push("debug=true");b.enablePluginSmoothing&&d.push("smoothing=true");b.enablePseudoStreaming&&d.push("pseudostreaming=true");g&&d.push("controls=true");b.pluginVars&&(d=d.concat(b.pluginVars));switch(a.method){case "silverlight":l.innerHTML='<object data="data:application/x-silverlight-2," type="application/x-silverlight-2" id="'+m+'" name="'+m+'" width="'+f+'" height="'+k+'" class="mejs-shim"><param name="initParams" value="'+d.join(",")+'" /><param name="windowless" value="true" /><param name="background" value="black" /><param name="minRuntimeVersion" value="3.0.0.0" /><param name="autoUpgrade" value="true" /><param name="source" value="'+
...
b+'" width="'+f+'" height="'+k+'" frameborder="0" class="mejs-shim" id="'+b+'" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>',"function"==typeof $f){var n=$f(l.childNodes[0]);n.addEvent("ready",function(){function a(b,c,d,e){b={type:d,target:c};"timeupdate"==d&&(c.currentTime=b.currentTime=e.seconds,c.duration=b.duration=e.duration);c.dispatchEvent(b.type,b)}n.playVideo=function(){n.api("play")};n.stopVideo=function(){n.api("unload")};n.pauseVideo=function(){n.api("pause")};n.seekTo=
...
(function(a,b,c){var d={locale:{language:b.i18n&&b.i18n.locale.language||"",strings:b.i18n&&b.i18n.locale.strings||{}},ietf_lang_regex:/^(x\-)?[a-z]{2,}(\-\w{2,})?(\-\w{2,})?$/,methods:{},getLanguage:function(){var a=d.locale.language||window.navigator.userLanguage||window.navigator.language;return d.ietf_lang_regex.exec(a)?a:null}};"undefined"!=typeof mejsL10n&&(d.locale.language=mejsL10n.language);d.methods.checkPlain=function(a){var b,c,d={"&":"&amp;",'"':"&quot;","<":"&lt;",">":"&gt;"};a=String(a);
for(b in d)d.hasOwnProperty(b)&&(c=new RegExp(b,"g"),a=a.replace(c,d[b]));return a};d.methods.t=function(a,b){d.locale.strings&&d.locale.strings[b.context]&&d.locale.strings[b.context][a]&&(a=d.locale.strings[b.context][a]);return d.methods.checkPlain(a)};d.t=function(a,b){if("string"===typeof a&&0<a.length){var c=d.getLanguage();b=b||{context:c};return d.methods.t(a,b)}throw{name:"InvalidArgumentException",message:"First argument is either not a string or empty."};};b.i18n=d})(document,mejs);
(function(a,b){"undefined"!=typeof mejsL10n&&(a[mejsL10n.language]=mejsL10n.strings)})(mejs.i18n.locale.strings);
