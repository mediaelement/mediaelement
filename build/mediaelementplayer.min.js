...
g.removeClass("mejs-mute").addClass("mejs-unmute")}else{p(d.volume);g.removeClass("mejs-unmute").addClass("mejs-mute")}},false);if(this.container.is(":visible")){p(a.options.startVolume);a.options.startVolume===0&&g.find("button").click();d.pluginType==="native"&&d.setVolume(a.options.startVolume)}}}})})(mejs.$);
