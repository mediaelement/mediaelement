...
"volume","fullscreen"],isVideo:true,enableKeyboard:true,pauseOtherPlayers:true,keyActions:[{key:32,action:function(a,c){c.paused||c.ended?c.play():c.pause()}},{key:38,action:function(a,c){c.setVolume(Math.min(c.volume+0.1,1))}},{key:40,action:function(a,c){c.setVolume(Math.max(c.volume-0.1,0))}},{key:37,action:function(a,c){if(!c.ended&&!c.paused){a.showControls();a.startControlsTimer();c.setCurrentTime(Math.min(c.currentTime-c.duration*0.05,c.duration))}}},{key:39,action:function(a,c){if(!c.ended&&
!c.paused){a.showControls();a.startControlsTimer();c.setCurrentTime(Math.max(c.currentTime+c.duration*0.05,0))}}},{key:70,action:function(a){if(typeof a.enterFullScreen!="undefined")a.isFullScreen?a.exitFullScreen():a.enterFullScreen()}}]};mejs.mepIndex=0;mejs.players=[];mejs.MediaElementPlayer=function(a,c){if(!(this instanceof mejs.MediaElementPlayer))return new mejs.MediaElementPlayer(a,c);this.$media=this.$node=f(a);this.node=this.media=this.$media[0];if(typeof this.node.player!="undefined")return this.node.player;
else this.node.player=this;if(typeof c=="undefined")c=this.$node.data("mejsoptions");this.options=f.extend({},mejs.MepDefaults,c);mejs.players.push(this);this.init();return this};mejs.MediaElementPlayer.prototype={hasFocus:false,controlsAreVisible:true,init:function(){var a=this,c=mejs.MediaFeatures,b=f.extend(true,{},a.options,{success:function(e,g){a.meReady(e,g)},error:function(e){a.handleError(e)}}),d=a.media.tagName.toLowerCase();a.isDynamic=d!=="audio"&&d!=="video";a.isVideo=a.isDynamic?a.options.isVideo:
