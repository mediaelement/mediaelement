...
hideVideoControlsOnLoad:false,clickToPlayPause:true,iPadUseNativeControls:false,iPhoneUseNativeControls:false,AndroidUseNativeControls:false,features:["playpause","current","progress","duration","speed","tracks","volume","fullscreen"],isVideo:true,enableKeyboard:true,pauseOtherPlayers:true,keyActions:[{keys:[32,179],action:function(a,b){b.paused||b.ended?b.play():b.pause()}},{keys:[38],action:function(a,b){b.setVolume(Math.min(b.volume+0.1,1))}},{keys:[40],action:function(a,b){b.setVolume(Math.max(b.volume-
...
(function(f){f.extend(mejs.MepDefaults,{speeds:["1.50","1.25","1.00","0.75"],speedStyle:{"1.50":"mejs-speed-150","1.25":"mejs-speed-125","1.00":"mejs-speed-100","0.75":"mejs-speed-075"},defaultSpeed:"1.00"});f.extend(MediaElementPlayer.prototype,{buildspeed:function(a,b,c,e){if(a.isVideo){var d=this;if(this.media.pluginType=="native"){c='<div class="mejs-button mejs-speed-button mejs-speed-100"><button type="button"></button><div class="mejs-speed-selector"><ul>';var g;for(g=0;g<this.options.speeds.length;g++){c+=
'<li><input type="radio" name="speed" value="'+this.options.speeds[g]+'" id="'+this.options.speeds[g]+'" ';if(this.options.speeds[g]==this.options.defaultspeed){c+="checked=true ";c+='/><label for="'+this.options.speeds[g]+'" class="mejs-speed-selected">'+this.options.speeds[g]+"x</label></li>"}else c+='/><label for="'+this.options.speeds[g]+'">'+this.options.speeds[g]+"x</label></li>"}c+="</ul></div></div>";a.speedButton=f(c).appendTo(b);a.speedButton.hover(function(){f(this).find(".mejs-speed-selector").css("visibility",
